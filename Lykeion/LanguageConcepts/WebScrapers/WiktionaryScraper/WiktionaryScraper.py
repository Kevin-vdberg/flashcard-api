...
from Lykeion.LanguageConcepts.WebScrapers.WiktionaryScraper.EnWiktionaryScraper import EnWiktionaryScraper
from Lykeion.LanguageConcepts.WebScrapers.WiktionaryScraper.PtWiktionaryScraper import PtWiktionaryScraper
from Lykeion.LanguageConcepts.WebScrapers.WiktionaryScraper.FrWiktionaryScraper import FrWiktionaryScraper

from Lykeion.LanguageConcepts.types.Genders import Genders as gender_types
from Lykeion.LanguageConcepts.types.Languages import Languages as language_types
from Lykeion.LanguageConcepts.types.WordTypes import WordTypes as word_types
...
#Public functions
    def request_word(self, word: str, language: language_types) -> dict:
        ...
        try:
            ...
            # Make translation to make sure all data returned is the same for all languages
